import{_ as s,r as a,o as l,c as d,b as e,d as n,a as r,e as t}from"./app-a7ad09f6.js";const c={},o={href:"https://blog.csdn.net/CRMEB/article/details/119997159",target:"_blank",rel:"noopener noreferrer"},b=e("br",null,null,-1),h=t(`<h2 id="安装nginx" tabindex="-1"><a class="header-anchor" href="#安装nginx" aria-hidden="true">#</a> 安装nginx</h2><p>有关brew常用的指令如下：</p><ul><li>brew搜索软件命令： brew search nginx</li><li>brew安装软件命令： brew install nginx</li><li>brew卸载软件命令: brew uninstall nginx</li><li>brew升级命令： sudo brew update 执行安装命令：brew install nginx<br> 查看nginx信息：brew info nginx<br> 进入目录使用：brew services start nginx 启动nginx</li></ul><p>nginx配置文件</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>   server {
       listen 80;
