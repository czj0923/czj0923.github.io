import{_ as e,o as i,c as a,e as n}from"./app-2c798668.js";const d={},l=n(`<h2 id="垂直水平居中" tabindex="-1"><a class="header-anchor" href="#垂直水平居中" aria-hidden="true">#</a> 垂直水平居中</h2><h3 id="absolute-负margin-定宽高" tabindex="-1"><a class="header-anchor" href="#absolute-负margin-定宽高" aria-hidden="true">#</a> absolute + 负margin（定宽高）</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>position:absolute;
top:50%;
left:50%;
margin-left:-50px;
margin-top:-50px;
