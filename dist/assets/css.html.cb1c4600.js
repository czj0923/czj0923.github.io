import{_ as e,o as i,c as a,e as n}from"./app.eb57afcc.js";const d={},l=n(`<h2 id="\u5782\u76F4\u6C34\u5E73\u5C45\u4E2D" tabindex="-1"><a class="header-anchor" href="#\u5782\u76F4\u6C34\u5E73\u5C45\u4E2D" aria-hidden="true">#</a> \u5782\u76F4\u6C34\u5E73\u5C45\u4E2D</h2><h3 id="absolute-\u8D1Fmargin-\u5B9A\u5BBD\u9AD8" tabindex="-1"><a class="header-anchor" href="#absolute-\u8D1Fmargin-\u5B9A\u5BBD\u9AD8" aria-hidden="true">#</a> absolute + \u8D1Fmargin\uFF08\u5B9A\u5BBD\u9AD8\uFF09</h3><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>position:absolute;
top:50%;
left:50%;
margin-left:-50px;
margin-top:-50px;
