import{_ as e,o as n,c as i,e as s}from"./app-4416975f.js";const l={},d=s(`<h2 id="防抖debounce" tabindex="-1"><a class="header-anchor" href="#防抖debounce" aria-hidden="true">#</a> 防抖debounce</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>function debounce(fn,delay){
    let timer = null
    return function(){
        if(timer){
            clearTimeout(timer)
