import{_ as e,o as n,c as i,e as s}from"./app.9ba5c0b2.js";const l={},r=s(`<h2 id="\u9632\u6296debounce" tabindex="-1"><a class="header-anchor" href="#\u9632\u6296debounce" aria-hidden="true">#</a> \u9632\u6296debounce</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>function debounce(fn,delay){
    let timer = null
    return function(){
        if(timer){
            clearTimeout(timer)
